...
--dev_file "../MultiDCP/data/pert_transcriptom/signature_dev_cell_1.csv" --test_file "/raid/home/joshua/MultiDCP/MultiDCP/data/pert_transcriptom/06212022_signature_test_cell_4_small.csv" \
--dropout 0.3 --batch_size 128 --max_epoch 500 \
