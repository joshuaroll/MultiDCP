...
if __name__ == '__main__':
    ...
    parser.add_argument('--drug_file',default= "/home/jrollins/home/data/MultiDCP_data/all_drugs_l1000.csv")
    parser.add_argument('--gene_file',default="/home/jrollins/home/data/MultiDCP_data/gene_vector.csv")
    parser.add_argument('--train_file', default="/home/jrollins/home/data/MultiDCP_data/pert_transcriptom/signature_train_cell_1.csv")
    parser.add_argument('--dev_file', default="/home/jrollins/home/data/MultiDCP_data/pert_transcriptom/signature_dev_cell_1.csv")
    parser.add_argument('--test_file', default="/home/jrollins/home/data/MultiDCP_data/pert_transcriptom/06212022_signature_test_cell_4_small_filtered.csv")
    parser.add_argument('--batch_size', type = int, default=64)
    parser.add_argument('--ae_input_file', default="/home/jrollins/home/data/MultiDCP_data/gene_expression_for_ae/gene_expression_combat_norm_978_split4")
    parser.add_argument('--ae_label_file', default="/home/jrollins/home/data/MultiDCP_data/gene_expression_for_ae/gene_expression_combat_norm_978_split4")
    parser.add_argument('--cell_ge_file', help='the file which used to map cell line to gene expression file', default= "/home/jrollins/home/data/MultiDCP_data/adjusted_ccle_tcga_ad_tpm_log2.csv")
    parser.add_argument('--max_epoch', type = int, default = 1)
    parser.add_argument('--ground_truth_for_testset', help = "the file directory to save the predicted test dataframe", default="/home/jrollins/home/data/MultiDCP_data/predictions/0522_ground_truth_for_corr_check.csv")
    parser.add_argument('--predicted_result_for_testset', help = "the file directory to save the predicted test dataframe", default="/home/jrollins/home/data/MultiDCP_data/predictions/0720_test_reproduce.csv")
    parser.add_argument('--pretrained_model', type=str, default="/home/jrollins/home/projects/MultiDCP/trained_models/1013rand1.pt", help='add pretrained model path here if using pretrained model')
    ...
    parser.add_argument('--all_cells',default="/home/jrollins/home/data/MultiDCP_data/ccle_tcga_ad_cells.p")
